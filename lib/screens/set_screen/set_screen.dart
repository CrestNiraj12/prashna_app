...
import 'package:prashna_app/components/tab_view.dart';
...
class _SetScreenState extends State<SetScreen>
  ...
  //late Map _status;
  bool _loading = true;
  static List<String> tabs = [quizzes, oigs];
  ...
  Widget build(BuildContext context) {
    ...
    Widget _createDatasList(List datas, {String type = quizzes}) {
    ...
    Widget getPage(String type) {
      ...
      return dataList.isEmpty
          ...
          : _createDatasList(dataList, type: type);
    }
